const VERSION='1.1.0';
const CACHE='little-stars-shell-v2';
const ASSETS=['./','./index.html','./style.css?v=1.1.0','./app.js?v=1.1.0','./core.mjs?v=1.1.0','./icon.svg','./apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png','./manifest.webmanifest'];
