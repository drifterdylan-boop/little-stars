const VERSION='1.3.1';
const CACHE='little-stars-shell-v6';
const ASSETS=['./','./index.html','./style.css?v=1.3.1','./app.js?v=1.3.1','./core.mjs?v=1.3.1','./icon.svg','./apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png','./manifest.webmanifest'];
